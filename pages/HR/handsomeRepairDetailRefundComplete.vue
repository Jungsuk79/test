    ...
    <div class="content-wrap">
      ...
      <div class="my-page-r-box hansomecare-application">
        ...
        <div class="section-wrapper">
          ...
          <div v-else class="cmp-order-state">
            ...
            <div v-if="stepActive == '1'" class="text-center">
              <p class="cmp-font fnt-20 mt-10">환불신청이 접수되었습니다.</p>
            </div>
            <div v-if="stepActive == '2'" class="text-center"> 
              <p class="cmp-font fnt-20 mt-10">환불처리가 완료되었습니다.</p>
            </div>
          </div>
          <!-- //상태바 -->
          ...
          <!--결제정보-->
          <div v-if="stepActive == '2'" class="section-box pt-60 pb-24">
            <div class="cmp-sub-tit line mb-24">
              <h4 class="tit">환불정보</h4>
            </div>
            <div class="pb-24">
            ...
            <div class="refund-box">
              <ul class="cust">
                <li>
                  <p class="cmp-font fnt-14 mb-6">결제금액</p>
                  <p class="cmp-font fnt-20">12,342,678<span class="cmp-font fnt-14">원</span></p>
                </li>
                <li class="sign plus"></li>
                <li>
                  <p class="cmp-font fnt-14 mb-6">수선차감금액</p>
                  <p class="cmp-font fnt-20">12,000<span class="cmp-font fnt-14">원</span></p>
                </li>
                <li class="sign equal"></li>
                <li>
                  <p class="cmp-font fnt-14 mb-6">최종환불금액</p>
                  <p class="cmp-font fnt-20">12,330,678<span class="cmp-font fnt-14">원</span></p>
                </li>
              </ul>
            </div>

            <ul class="cmp-dotList mt-20">
              <li>환불처리시 카드 취소처리는 카드사에 따라서 영업일 기준 최대 3~5일 소요됩니다.<br/>궁금한 사항은 1:1 문의를 이용해 주시기 바랍니다.</li>
            </ul>
          </div>
          <!--결제정보-->
        </div>
        ...
        <div class="cmp-btnsArea center-area">
          <v-btn large color="primary">수선목록보기</v-btn>
        </div>
      </div>
    </div>
  </div>
