      ...
      <div class="my-page-r-box content-heart"><!-- 마이페이지 -->
        ...
        <v-tabs-items v-model="tabs" touchless class="mb-30">
          ...
          <v-tab-item :transition="false">
            ...
            <ProductListPaging />
            <!-- 20221202 수정 : 취향 참여내역 없는경우  -->
            <CommonNoData class="border-b1">
               <template #message>
                <div class="liking-noCont">
                  <span>‘취향의 발견’ 참여 내역이 없습니다.</span>
                  <span>취향의 발견은 <nuxt-link to="">모바일 > 콘텐츠</nuxt-link> 홈에서 참여하실 수 있어요!</span>
                </div>
               </template>
            </CommonNoData>
            <!-- // 20221202 수정 : 취향 참여내역 없는경우  -->
...
export default {
  ...
  data() {
    return {
      ...
      // [퍼블수정]220808 product_name 데이터추가
      productList : [
        {
