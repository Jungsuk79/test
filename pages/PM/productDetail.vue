      ...
      <div><!-- [퍼블수정]22.12.06 수정 이미지 확대보기 시 사라짐 삭제 -->
        ...
        <div class="prd-detail-top">
          ...
          <div class="swiper-box">
              ...
              class="detail-top-swiper thumb">
                <SwiperSlide v-for="(item, index) in prdData[prdSelectIdx].images" :key="index">
                  <div class="swiper-cnt" :class="{selected: curSlideIdx === index}">
                    ...
                    <!-- 동영상 썸네일 -->
                    <div v-if="index === prdData[prdSelectIdx].images.length - 1" class="play-ico-cnt">
            ...
            <button v-show="!isTopSlideVideo" class="cody-lookbook-btn">
              <span class="icon"></span>
              <span class="txt">코디&amp;룩북</span>
            </button>
            <button v-show="swiperPlayBtnShow && topSwiperBtnShow && !isTopSlideVideo" class="video-play-btn" @click="topSwiperSlideTo(prdData[prdSelectIdx].images.length - 1,300)">
          ...
          <div class="detail-top-info">
            ...
            <div class="top-info-box">
              <dl class="prd-info"><!-- [개발확인]22.12.28 안의 내용이 없다면 미노출 되도록 부탁 드립니다. -->
                <dt>컬러</dt>
                <!-- 컬러칩 -->  
