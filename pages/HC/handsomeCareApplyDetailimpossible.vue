  ...
  <div class="contents contents-type2"><!-- 레이아웃 설명 /ko/guide/Structure 참고 -->
    <div class="content-wrap">
      ...
      <div class="my-page-r-box hansomecare-application">
        ...
        <div class="section-wrapper">
          ...
          <div v-else class="cmp-order-state">
            ...
            <div v-if="stepActive == '3'" class="text-center"> 
              <p v-if="CareBlock" class="cmp-font fnt-20 mt-10">모든 상품의 세탁이 불가능합니다.</p>
              <p v-else class="cmp-font fnt-20 mt-10">검수결과 및 결제정보를 확인하고 결제해 주세요.</p>
            </div>
          ...
          <div class="section-box pt-60">
            ...
            <ul class="cmp-dotList mt-20"><!-- [퍼블수정] 22.10.20 문구 수정 -->
              <li>케어플러스 세탁 서비스 신청시 결제금액은 담당자 검수완료 후 실 결제금액이 확정되며, 검수결과에 따라 최종 결제금액이 변경 될 수 있습니다. 검수가 완료되면 알림이 발송되며, 결제요청 알림을 확인 후 결제를 진행해주시기 바랍니다.</li>
              <!-- [퍼블수정]23.02.22 문구수정 -->
          ...
          <!-- '결제하기'에만 노출 -->
          <template v-if="stepActive == '3' && !CareBlock">
          <!--결제수단-->
          <div class="section-box pt-60">
        ...
        <!-- '결제하기'에만 노출 -->
        <div v-if="stepActive == '3' && !CareBlock" class="payment-info">
          총 <strong>3</strong>개 <strong>12,345,000</strong>원 결제하시겠습니까?
        </div>

        <!-- '결제하기'에만 노출 -->
        <div v-if="stepActive == '3' && !CareBlock" class="cmp-btnsArea center-area">
           <v-btn outlined large color="primary">취소하기</v-btn>
          <v-btn large color="primary">결제하기</v-btn>
        </div>

        <!-- '접수','세탁진행중' ,'배송' 노출 -->
        <div v-if="stepActive == '1' || stepActive == '4' || stepActive == '5' || CareBlock" class="cmp-btnsArea center-area">
