        ...
        <div class="section-wrapper">
          ...
          <div v-else class="cmp-order-state">
            ...
            <div v-if="stepActive == '4'" class="text-center"> 
              <!-- 매장 수령 케이스 -->
              <p class="cmp-font fnt-20 mt-10">매장 방문하여 세탁 상품을 수령하세요.</p>
              <!-- <p class="cmp-font fnt-20 mt-10">세탁 상품 수령이 완료되었습니다.</p> -->
            </div>
          </div>
          <!-- //상태바 -->
          <!-- // [퍼블수정] 22.10.20 상태 별 문구 삽입 -->
...
export default {
  ...
  data: () => ({
    ...
    stateText1: [
      { id: 1, name: '접수'},
      { id: 2, name: '결제하기'},     //  [퍼블수정]22.11.24 문구수정
      { id: 3, name: '세탁진행중'},   //  [퍼블수정]22.11.24 문구수정
      { id: 4, name: '매장수령'},
    ],
    tooltipList: {
      // 툴팁 상세 정보
