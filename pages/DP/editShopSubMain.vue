...
export default {
  ...
  data: () => ({
    ...
    brandList : [
      ...
      {
        brand_name : 'LES COYOTED<br/>DE PARIS',
      ...
      {
        brand_name : 'BAUM UND<br/>PFERFGARTEN',
    ...
    newPrdList : [
      {
          ...
          "product_name": "포켓 싱글 재킷포켓 싱글 재킷포켓 싱글 재킷포켓 싱글 재킷포켓 싱글 재킷포켓 싱글 재킷포켓 싱글 재킷포켓 싱글 재킷",
          "sell_price": "350000",
  ...
  mounted(){
    // [퍼블수정]편집샵 - 셀렉티드 수정 ( 브랜드 로고 이미지 삽입 예시 )
    EventBus.$emit("setHeader", {static: true, type: "editshopSubMain", brand: "TOM GREYHOUND", brand_image : "/images/common/logo-system.svg"})
  },// mounted
