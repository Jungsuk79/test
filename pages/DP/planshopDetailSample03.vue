<template>
  <div class="contents">
    <div class="content-wrap content-planshopTemp">
        <MagHeader :data="{title:'기획전',subTitle : subTitle, date:'2021.12.29'}" />
        <!-- [s] 상단 html에디터 -->
        <div class="mag-temp-full-width">
            <div class="main-imgArea mb-60">
              <!--html 등록 Start -->
              <div class="pc-planshop2023-detail03">
                <div class="img-area">
                  <img src="https://img.thehandsome.com/md/publish/dummy/pc/planshop/03/pc_detail_01.jpg"/>
                </div>
                <div class="img-area link-div">
                  <a class="link left" href="#n">SYSTEM more items</a><!-- SYSTEM 더보기 링크 : href="링크" 입력  -->
                  <a class="link right" href="#n">SJSJ more items</a><!-- SJSJ 더보기 링크 : href="링크" 입력  -->  
                  <img src="https://img.thehandsome.com/md/publish/dummy/pc/planshop/03/pc_detail_02.jpg"/>
                </div>
                <div class="img-area link-div">
                  <a class="link left" href="#n">O'2nd more items</a><!-- O'2nd 더보기 링크 : href="링크" 입력  -->
                  <a class="link right" href="#n">SYSTEM HOMME more items</a><!-- SYSTEM HOMME 더보기 링크 : href="링크" 입력  -->  
                  <img src="https://img.thehandsome.com/md/publish/dummy/pc/planshop/03/pc_detail_03.jpg"/>
                </div>
              </div>
              <style type="text/css">
                .pc-planshop2023-detail03 .img-area{display: block;}
                .pc-planshop2023-detail03 .img-area img{display: block; margin:0 auto;}
                .pc-planshop2023-detail03 .img-area.link-div{position:relative;}
                .pc-planshop2023-detail03 .img-area.link-div a.link{position: absolute;text-indent: -9999px; font-size:0; color:transparent !important; width:50%; top:0; height:100%;}
                .pc-planshop2023-detail03 .img-area.link-div a.link.left{left:0;}
                .pc-planshop2023-detail03 .img-area.link-div a.link.right{right:0;}
              </style>
              <!--html 등록 End -->
            </div>
        </div>
...
export default {
  ...
  data: () => ({
    ...
    subTitle : "[캐주얼] SYSTEM / SJSJ / O'2nd / SYSTEM HOMME 22FW 시즌오프",
    productList : [
      {
