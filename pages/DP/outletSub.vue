...
export default {
  ...
  data: () => ({
    mainBanner:[
      {
          title: "연말을 빛낼 레이어드",
          desc: "다가오는 연말! 기분 전환을 시켜줄<br>컬러풀한 겨울스타일링",
          image_url : "https://img.thehandsome.com/md/publish/dummy/pc/outlet-sub-banner.png",
          link_url : "#none"
      },
    ],
  ...
  mounted(){
    EventBus.$emit("setHeader", {static: true, type: "outletSub", brand : "BALLY"})
  },// mounted
