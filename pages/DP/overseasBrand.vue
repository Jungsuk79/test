<template>
  <div class="contents contents-brand"><!-- 레이아웃 설명 /ko/guide/Structure 참고 -->  
    <!--
      ...
      - <div class="overseas-brand-cont"> 추가
      - 상단 비주얼, 상단배너 <section> (v-for용) 추가
      - 상단 비주얼 텍스트 타입 추가
      - 공통배너 추가
    -->
    <div class="overseas-brand-cont">
      <!-- 상단 비주얼 -->
      <section>
        <!-- 이미지 타입 -->
    ...
    <div class="content-wrap">
      ...
      <CommonNavigationBar test="fold2"/><!-- 220916 메뉴 : 추가 (test : 퍼블화면 확인용) -->
...
export default {
  ...
  data: () => ({
    topVisual : {
        title: "BALLY",
        desc: "세상에 없던 뷰티를 향한<br>가장 이상적인 아름다움을 담은 브랜드",
        image_url : "https://img.thehandsome.com/md/publish/dummy/pc/overseas-brand-banner0.png",
    },
    mainBanner:[
      {
          title: "지속가능한 브랜드 발리의<br>악세서리 컬렉션",
          desc: "BALLY 22 S/S 신규 브랜드",
          image_url : "https://img.thehandsome.com/md/publish/dummy/pc/overseas-brand-banner1.png",
          link_url : "#none"
      },
      {
          title: "지속가능한 브랜드 발리의<br>악세서리 컬렉션",
  ...
  mounted(){
    EventBus.$emit("setHeader", {static: true, type: "overseasBrand", brand : "BALLY"}) // 230213 브랜드 : brand_image 삭제
  },// mounted
