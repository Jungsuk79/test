    ...
    <template #body>
      <div class="inner">
        ...
        <div class="product-row-group line-type2">
          <ProductRowUnit :unit-data="unitData">
          </ProductRowUnit>
        </div>
        <div class="cmp-form-boxGroup box-type1">
          ...
          <!-- 구매후기 가이드 -->
          <div class="review-info-box review-box">
            <p class="review-title"><i class="cmp-icon-etc cmp-icon-18 i-pencil">연필</i><img src="https://img.thehandsome.com/md/publish/dummy/pc_review_text.png" alt="review" />는 이렇게 작성해보세요</p>
            <div class="review-exlist">
              <div>
                <img src="https://img.thehandsome.com/md/publish/dummy/pc_review01.png">
                <p>취향을 담은<br>나만의 스타일링</p>
              </div>
              <div>
                <img src="https://img.thehandsome.com/md/publish/dummy/pc_review02.png">
                <p>일상의 영감을<br>주는 연출팁</p>
              </div>
              <div>
                <img src="https://img.thehandsome.com/md/publish/dummy/pc_review03.png">
                <p>사용 후 피부의<br>톤과 결 차이</p>
              </div>
            </div>
            <!-- 동기부여 -->
             <div class="review-event">
              <p>
                <b>월간 리뷰 TOP 100 선정 시, 추가 5,000M</b><br/>
                50자 이상 포토 리뷰 작성 시 당첨확률 UP!
              </p>
              <img src="https://img.thehandsome.com/md/publish/dummy/pc_review_event.png" alt="Review Event">
             </div>
            <!-- // 동기부여 -->
          </div>
          <!-- // 구매후기 가이드 -->
          ...
          <!-- 구매후기 -->
          <div class="cmp-form-box required">
            <p class="form-tit">자세한 후기를 적어주세요</p>
            <v-textarea 
              outlined :no-resize="true" 
              height="199" counter="1000" maxlength="1000" 
              class="cmp-form-textarea counting">
              <template #label>
                <div>최소 10자 이상으로 착용 및 사용 후<br>느낀점과 코디 팁을 자유롭게 적어주세요!<br><br>포토 리뷰는 스타일라이브로 동시 등록해보세요<br>스타일라이브에 게시한 나의 코디 팁으로<br>쇼핑에 도움을 받은 스라피플이 있으면<br>1% 추가 적립 혜택도 받아요</div>
              </template>
            </v-textarea>
          </div>
          <!-- //구매후기 -->
          ...
          <!-- //포토/동영상 리스트 -->
          <!-- [퍼블수정]24.10.28 상품평 3차 -->
          <div class="check-photo-mileage">
            <p v-if="attachFileList.length > 1" class="check-blue"><i class="cmp-icon-etc cmp-icon-24 i-checkBlue">체크</i>포토/동영상 등록시 최대 2,000M</p>
            <p v-else class="check-gray"><i class="cmp-icon-etc cmp-icon-24 i-checkGray">체크</i>포토/동영상 등록시 최대 2,000M</p>
          </div>
          <!-- //[퍼블수정]24.10.28 상품평 3차 -->
        </div>
        <!-- 유의사항 -->
