      ...
      <div class="my-page-r-box orderinquiry-detail"><!-- 마이페이지 --><!-- [퍼블수정]22.11.30 주문 조회 상세 수정 -->
        ...
        <div class="product-row-table">
          <table>
            ...
            <tbody>
              <template v-for="(item, index) in itgbDetailData ">
                <tr :key="index" :class="{'bottom-none':item.notice!==null || item.reason!==null || item.gift_list}">
                  ...
                  <td>
                    <div v-if="index == 0"><!-- 주문취소 CASE -->
                      <!-- [퍼블수정]22.11.07 -->
                      <p class="cmp-font">주문취소</p>
                      <p class="cmp-font c-gray">2021.10.30</p>
                    </div>
                    <div v-if="index == 1"><!-- 교환배송완료 CASE -->
                      <p class="cmp-font">교환배송완료</p>
                      <p class="cmp-font c-gray">2021.10.30</p>
                    </div>
                    <div v-if="index == 2"><!-- 반품완료 CASE -->
                      <p class="cmp-font">반품완료</p>
                      <p class="cmp-font c-gray">2021.10.30</p>
                    </div>
                    <div v-if="index == 3"><!-- N번 교환하다 반품 - 완료 CASE -->
                      <p class="cmp-font">반품완료</p>
                      <p class="cmp-font c-gray">2021.10.30</p>
                    </div>
                  </td>
                  <td class="pw-16">
                    <div v-if="index == 0" class="product-row-unitBtn"><!-- 주문취소 CASE -->
                      <v-btn outlined small color="normal">취소 상세</v-btn>
                    </div>
                    <div v-if="index == 1" class="product-row-unitBtn"><!-- 교환배송완료 CASE -->
                    ...
                    <div v-if="index == 2" class="product-row-unitBtn"><!-- 반품완료 CASE -->
                      <v-btn outlined small color="normal">반품 상세</v-btn>
                      <v-btn outlined small color="normal">배송 조회</v-btn>
                    </div>
                    <div v-if="index == 3" class="product-row-unitBtn"><!-- N번 교환하다 반품 - 완료 CASE -->
                      <v-btn outlined small color="normal">반품 상세</v-btn>
                      <v-btn outlined small color="normal">교환 상세</v-btn>
                      <v-btn outlined small color="normal">배송 조회</v-btn>
                    </div>
                  ...
                  <td colspan="4" class="td-l pw-0" :class="{'pb-0' : item.gift_list}">
                    <ul class="cmp-info list-type1">
                      <li class="cmp-font fnt-14">
                        <p v-if="item.reason">
                          <b v-if="index == 0" class="mr-10">취소 사유 :</b><!-- 주문취소 CASE -->
                          <b v-if="index == 1" class="mr-10">교환 사유 :</b><!-- 교환배송완료 CASE -->
                          <b v-if="index == 2" class="mr-10">반품 사유 :</b><!-- 반품완료 CASE -->
                          <b v-if="index == 3" class="mr-10">반품 사유 :</b><!-- N번 교환하다 반품 - 완료 CASE -->
                ...
                <tr v-if="item.gift_list" v-for="(item3, index3) in item.gift_list" class="gift-type"><!-- [퍼블 수정] 22.09.27 -->
                  <td class="pw-0 ">
                    <nuxt-link :to="item3.link" class="product-row-unitInfo or-prd-type"><!-- [퍼블수정]23.01.19 상품이미지 : or-prd-type 클래스 추가 -->
        ...
        <ul v-if="isItgb" class="cmp-info list-type1 mt-14">
        ...
        <div v-if="isItgb" class="cmp-sub-tit col mt-60">
          <h3 class="tit">사은품</h3><!-- [퍼블수정] 22.09.30 주문조회 수정 -->
        </div>
        <div v-if="isItgb" class="product-row-table">
          <table>
            <caption>상품리스트</caption>
            <colgroup>
              <col style="width:auto;"/>
        ...
        <div class="return-info no-tit no-bt">
          <div class="box">
            ...
            <dl v-if="isItgb" class="pack-info">
        ...
        <div v-if="isItgb">
          ...
          <!-- 교환배송비 -무료쿠폰 -->
          <div class="cmp-sub-tit col line mt-60">
            <h3 class="tit">교환 배송비</h3>
          </div>
          <div class="return-info deliv-info">
            <div class="box">
              <dl class="pack-info">
                <dd class="txt">쿠폰 사용</dd>
              </dl>
            </div>
          </div>
          <div class="cmp-info info-type3 table-type mt-20">
          ...
          <div class="return-info deliv-info">
            <div class="box">
              <dl class="pack-info">
                <dd class="txt">STAR/THE STAR 등급 혜택</dd>
              </dl>
            </div>
          </div>
          <div class="cmp-info info-type3 table-type mt-20">
          ...
          <!-- 교환배송비 - 신용카드 결제(동일 카드) -->
          <div class="cmp-sub-tit col line mt-60">
            <h3 class="tit">교환 배송비 합계</h3>
          </div>
          <div class="return-info deliv-info">
            <div class="box">
              <dl class="pack-info">
                <!-- [퍼블수정]22.11.21 주문서조회 수정 -->
                <dd class="txt"><b>신용카드</b> / <span>삼성카드</span></dd>
              </dl>
            </div>
          </div>
          <div class="cmp-info info-type3 table-type mt-20">
          ...
          <div class="return-info deliv-info">
            <div class="box">
              <dl class="pack-info">
                <!-- [퍼블수정]22.11.21 주문서조회 수정 -->
                <dd class="txt"><b>신용카드</b> / <span>삼성카드</span><span class="add-info">현대카드</span></dd>
              </dl>
            </div>
          </div>
          <div class="cmp-info info-type3 table-type mt-20">
          ...
          <div class="return-info deliv-info">
            <div class="box">
              <dl class="pack-info">
                <!-- [퍼블수정]22.11.21 주문서조회 수정 -->
                <dd class="txt"><b>신용카드</b> / <span>삼성카드</span><span class="add-info">쿠폰사용</span><span class="add-info">STAR/THE STAR 등급 혜택</span></dd>
              </dl>
            </div>
          </div>
          <div class="cmp-info info-type3 table-type mt-20">
        ...
        <div class="cmp-sub-tit mt-60">
          <h3 class="tit">최종 환불정보</h3>
        </div>
        <div class="refund-box">
          <ul class="cust">
            <li>
              <p class="cmp-font fnt-14 mb-6">취소/반품상품 결제금액</p>
          ...
          <div v-if="isItgb" class="cmp-info info-type2 mt-10">
        ...
        <!-- 환불 안내 -->
        <!-- [무형상품] mt-24 클래스 추가 -->
        <v-expansion-panels accordion class="cmp-acc acc-type2 last-bt-none" :class="{'mt-24' :  !isItgb}">
  ...
  data() {
    return {
      ...
      itgbDetailData: [
        ...
        {
          brand_name: 'MOMENT',
          product_name: '달리기 : 마음이 즐거워지는 아크릴 아크릴 아크릴 아크릴 아크릴',
      ...
      prdDetailData: [
        ...
        },
        {
          ...
          link: '#n',
          reason: ['상품불량'],
          notice: ['자세한 사유는 여기에 표기(없을 경우 미표기)'],
          sold_out: false,
          zzim : false,
        },
        {
