  ...
  <div class="contents contents-type2"><!-- 레이아웃 설명 /ko/guide/Structure 참고 -->
    <div class="content-wrap content-oeder-form"><!-- [퍼블수정]23.01.18 -->
      ...
      <div class="order-content-box">
        ...
        <!-- [무형상품] 추가 -->
        <div class="product-row-unitNotice point-red mt-8">
          <ul class="product-notice">
            <li>클래스 행사일이 임박하여 주문취소/부분취소가 불가합니다. (행사 5일전까지 주문취소 가능)</li>
          </ul>
        </div>

        <p v-if="isItgb" class="cmp-font fnt-14 c-red mt-10">임직원 할인은 정상가 기준으로 적용 됩니다.</p>
        <!-- //주문상품 리스트 -->

        <!-- 쇼핑백포장, 선물포장 신청 -->
        <div v-if="isItgb" class="or-chkbox-space">
          ...
          <!-- 주문서 상품 3개 이상일 때 활성화-->
          <p v-if="isItgb" class="v-input--info color-red pl-26 mt-9">선물포장 서비스는 2개 이하의 상품 주문 건에 한해 이용이 가능합니다.</p>

          <template v-if="giftWrappingCheck && isItgb">
            <div class="mt-24">
          ...
          <template v-if="radioModel === 3 && isItgb">
        ...
        <div v-if="isItgb" class="contents-line-box">
          ...
          <!-- 입력 전 -->
          <!--<p class="cmp-font c-gray">배송 요청사항을 선택해 주세요.</p>-->
          <!-- //입력 전 -->
          <p class="cmp-font">
            부재 시 문 앞에 놓아주세요
            <br>공동현관 출입번호(****)
        ...
        <div class="contents-line-box">
          <!-- [무형상품] 클래스 추가 -->
          <div class="cmp-sub-tit small justify-start" :class="{'mb-12' : !isItgb}">
            <h4 class="tit">포인트 사용</h4>
            <CommonTooltipBox :tooltip-list="tooltipList.point_use" />
          </div>

          <!-- [무형상품] 추가 -->
          <p class="cmp-font fnt-13 mb-20">해당 상품은 포인트(한섬마일리지/H.Point/e-money) 사용이 불가합니다.</p>
        ...
        <div class="contents-line-box">
          ...
          <div class="payment-select-etc box-4">
        ...
        <!-- //결제수단 선택 -->
        <!-- 팝업버튼&배너 -->
         <!-- [무형상품] 마지막 contents-line-box 에 last 추가-->
        ...
        <!-- 개인정보 제3자 제공 동의 (220920 개인정보 : 추가) -->
         <!-- [무형상품] 제외 -->
        <div v-if="isItgb" class="contents-line-box last">
          <div class="cmp-sub-tit small">
        ...
        <div class="order-price-box">
          <div class="price-sticky-box">
            ...
            <p class="cmp-font fnt-13 pt-12">해당 상품은 구매적립(한섬마일리지/H.Point)이<br />불가합니다.</p>
            <!-- [무형상품] 체크박스 추가 및 코드 재정의 -->
             <!-- 24년 9월 시행 법령에따라 삭제 조치 -->
            <!-- <div class="chk-wrap">
              <v-checkbox v-model="privacyPolicyCheckA" class="cmp-form-checkbox mt-34 lines">
                <template #label>
                  <div>개인정보수집･이용동의<i class="required"></i></div>
                </template>
              </v-checkbox>
              <v-btn text class="cmp-font fnt-13 button right-btn"><span class="line">안내보기</span></v-btn>
            </div>
            <div class="chk-wrap">
              <v-checkbox v-model="privacyPolicyCheckB" class="cmp-form-checkbox mt-16 lines">
                <template #label>
                  <div>개인정보 3자 제공동의<i class="required"></i></div>
                </template>
              </v-checkbox>
              <v-btn text class="cmp-font fnt-13 button right-btn"><span class="line">안내보기</span></v-btn>
            </div> -->
            <!-- // 24년 9월 시행 법령에따라 삭제 조치 -->
            <div class="chk-wrap mt-34">
              <v-checkbox v-model="buyAgreeCheck" class="cmp-form-checkbox mt-16 lines"><!-- 221024 주문서 : v-model 추가 -->
                <template #label><div>구매 동의<i class="required"></i></div></template><!-- 220920 개인정보 : label 마크업 수정 -->
              </v-checkbox>
              <p class="cmp-font fnt-14 mt-10">주문할 상품의 상품명, 가격, 배송정보 등을 확인하였으며, 구매 진행에 동의합니다. (전자상거래법 제 8조 2항)</p>
            </div>
  ...
  data() {
    return {
      ...
      itgbList: [
        {
          ...
          image: 'https://img.thehandsome.com/md/publish/dummy/pc/pc-itgb-0002.jpg',
          options: ['12:30'],
          sell_price: '355000',
          discount: '20',
          price: '266000',
      ...
      */
      ...
      privacyPolicyCheckA: false, // 개인정보수집･이용동의 체크박스
      privacyPolicyCheckB: false, // 개인정보 3자 제공동의 체크박스
