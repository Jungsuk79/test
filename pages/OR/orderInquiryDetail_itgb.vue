              ...
              <template v-for="(item, index) in itgbDetailData">
                <tr :key="index" :class="{'bottom-none':item.notice!==null || item.reason!==null || item.gift_list}">
                  ...
                  <td>
                    ...
                    <div v-if="index == 2" class="cmp-font c-blue">상품준비중</div><!-- 상품준비중 CASE -->
                  </td>
                  <td class="pw-16">
              ...
              <template v-for="(item, index) in giftsData">
                <tr :key="index">
                  ...
                  <td class="pw-16"><!-- [퍼블수정] 22.09.30 주문조회 수정 -->
                    <div v-if="index == 3 | index == 4" class="product-row-unitBtn">
                      <v-btn outlined small color="normal">배송 조회</v-btn>
                    </div>
                  </td>
                </tr>
    ...
    return {
      ...
      giftsData : [ // 증정품,사은품
        ...
        },
        {
          ...
          desc : '정상 30만원 이상 구매 고객님께 구매 사은품으로<br/>톰그레이하운드 X 콤팩트레 미니 에코백을 드립니다.',
        },
        {
          type : 'mileage',
          mileage : 100000,
        ...
        },
        {
          ...
          date : '6월 14일 ~ 소진 시 까지',
          desc : '폼더스토어, 폼맨즈라운지 IPANEMA 상품 구매 고객님께 사은품으로<br/>IPANEM 에코백을 드립니다.',
        },
        {
          type : 'event',
          link: '#n',
