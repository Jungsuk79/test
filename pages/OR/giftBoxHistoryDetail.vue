  ...
  <div class="contents contents-type2"><!-- 레이아웃 설명 /ko/OR/guide/Structure 참고 -->
    <div class="content-wrap">
      ...
      <div class="my-page-r-box content-myGiftbox"><!-- 마이페이지 -->
              ...
              <template v-for="(item, index) in prdDetailData">
                <tr :key="index" :class="{'bottom-none':item.notice!==null || item.reason!==null || item.gift_list}">
                  ...
                  <td class="pw-0">
                    ...
                    <div v-if="index == 1" class="cmp-font c-blue">상품 준비중</div><!-- 상품 준비중 CASE -->
                  </td>
                  <td class="pw-16">
        ...
        <!-- 상품 상세 증정&사은품 table calse [퍼블수정] 22.09.30 주문조회 수정 -->
                  ...
                  <td class="pw-24 pl-0">
                    <div class="product-row-unitInfo gifts-type">
                      ...
                      <div class="product-info-cnt">
                        ...
                        <div v-if="item.type==='mileage'" class="product-name">{{item.accrual_date + ' 이후 적립 예정'}}</div><!-- [퍼블수정] 22.09.30 주문조회 수정 -->
...
export default {
  ...
  data() {
    return {
      ...
      // 230206 선물하기 : 추가 End
      prdDetailData: [
        // 상품 상세 데이터 [퍼블수정] 22.09.30 주문조회 수정 -->
        {
