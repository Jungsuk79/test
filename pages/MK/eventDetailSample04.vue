    ...
    <div class="content-wrap">
      <div class="event-detail">
        ...
        <div class="html-area" style="text-align:center;">
          <!-- html 등록 영역 시작 -->
          <div class="pc-event2023-detail04">
            <div class="img-area">
              <img src="https://img.thehandsome.com/md/publish/dummy/pc/event/04/pc_detail_01.jpg"/>
            </div>
            <div class="img-area link-box">
              <a class="ios-btn" href="#n">ios 앱 다운로드</a><!-- ios 앱 다운로드 링크 : href="링크" 입력  -->
              <a class="android-btn" href="#n">안드로이드 앱 다운로드</a><!-- 안드로이드 앱 다운로드 링크 : href="링크" 입력  -->
              <img src="https://img.thehandsome.com/md/publish/dummy/pc/event/04/pc_detail_02.jpg"/>
            </div>
            <div class="img-area">
              <img src="https://img.thehandsome.com/md/publish/dummy/pc/event/04/pc_detail_03.jpg"/>
            </div>
          </div>
          <style type="text/css">
          .pc-event2023-detail04 .img-area{display: block;}
          .pc-event2023-detail04 .img-area img{display: block; margin:0 auto;}
          .pc-event2023-detail04 .img-area.link-box{position:relative;}
          .pc-event2023-detail04 .img-area.link-box a{position: absolute;width: 25.7%;height: 6.6%;text-indent: -9999px; font-size:0; color:transparent !important; bottom:53.9%;}
          .pc-event2023-detail04 .img-area.link-box a.ios-btn{left:24.0%;}
          .pc-event2023-detail04 .img-area.link-box a.android-btn{right:24.0%;}
          </style>
          <!-- html 등록 영역 끝 -->
        </div>
