    ...
    <div class="content-wrap">
      <div class="event-detail">
        ...
        <div class="html-area" style="text-align:center;">
          <!-- html 등록 영역 시작 -->
          <div class="pc-event2023-detail05">
            <div class="img-area">
              <img src="https://img.thehandsome.com/md/publish/dummy/pc/event/05/pc_detail_01.gif"/>
            </div>
            <div class="img-area">
              <img src="https://img.thehandsome.com/md/publish/dummy/pc/event/05/pc_detail_02.jpg"/>
            </div>
            <div class="img-area link-box">
              <a class="tolk-btn" href="#n">톡 채널 바로가기</a><!-- 톡 채널 바로가기 : href="링크" 입력  -->
              <img src="https://img.thehandsome.com/md/publish/dummy/pc/event/05/pc_detail_03.jpg"/>
            </div>
          </div>
          <style type="text/css">
          .pc-event2023-detail05 .img-area{display: block;}
          .pc-event2023-detail05 .img-area img{display: block; margin:0 auto;}
          .pc-event2023-detail05 .img-area.link-box{position:relative;}
          .pc-event2023-detail05 .img-area.link-box a.tolk-btn{position: absolute;width: 15.9%;height: 5.2%;text-indent: -9999px; font-size:0; color:transparent !important; top:27.0%;left:30.5%;}
          </style>
          <!-- html 등록 영역 끝 -->
        </div>
