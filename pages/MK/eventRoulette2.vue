          ...
          <div class="roulette-area" style="background-color:#fff;">
            ...
            <div class="rouletter">
              <div class="rouletter-bg">
                  <div class="rouletter-wacu" style="background-image : url(https://cdn-img.thehandsome.com/md/publish/event/240131_roulette/pc-roulette_circle6.png)">
    ...
    rouletteLayerPopup(num) {
      switch (num) {
        ...
        case 3:
          ...
          break;
        case 4:
          alert("당첨!! 5,000M 마일리지");
          break;
        case 5:
          alert("당첨!! 10,000M 마일리지");
          break;
        default:
          alert("꽝! 다음기회에");
      }
